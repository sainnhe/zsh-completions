...
Docs\: https\://deno.land/manual@v1.36.3/basics/permissions
Examples\:
  --allow-read
...
https\://deno.land/manual@v1.36.3/basics/permissions
]' \
...
'--reporter=[Select reporter to use. Default to '\''pretty'\''.]: :(pretty dot junit)' \
'--unstable[Enable unstable features and APIs]' \
'-q[Suppress diagnostic output]' \
'--quiet[Suppress diagnostic output]' \
'--no-remote[Do not resolve remote modules]' \
